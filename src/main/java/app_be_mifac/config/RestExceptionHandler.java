...
import app_be_mifac.validation.ErrorDetail;
import app_be_mifac.validation.ValidationError;
...
public class RestExceptionHandler {
    ...
    public ErrorDetail handleValidationError(MethodArgumentNotValidException manve) {
